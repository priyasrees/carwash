	...
	var t = {
			...
			"./src/index.js": function(t, e, r) {
				...
				t.exports = function(t, e, h) {
					...
					d = {
						start: function() {
							v.listClass = "list", v.searchClass = "search", v.page = 1e4, v.i = 1, v.items = [], v.visibleItems = [], v.matchingItems = [], v.searched = !1, v.filtered = !1, v.searchColumns = void 0, v.searchDelay = 0, v.handlers = {
								updated: []
				...
				t.exports = function(t) {
					var e = !1,
						r = function(r, s) {
							...
							var i, o = t.matchingItems.length,
								l = t.i,
								u = t.page,
								c = Math.ceil(o / u),
								f = Math.ceil(l / u),
					...
					this.get = function(e, n) {
							...
							for (var s = {}, i = 0, a = n.length; i < a; i++) {
								var o = void 0,
									l = n[i];
								if (l.data)
									for (var u = 0, c = l.data.length; u < c; u++) s[l.data[u]] = t.utils.getAttribute(e.elm, "data-" + l.data[u]);
								else l.attr && l.name ? (o = t.utils.getByClass(e.elm, l.name, !0), s[l.name] = o ? t.utils.getAttribute(o, l.attr) : "") : (o = t.utils.getByClass(e.elm, l, !0), s[l] = o ? o.innerHTML : "")
							}
							return s
			...
			"./src/utils/get-attribute.js": function(t) {
				t.exports = function(t, e) {
					...
					if (!r)
						for (var n = t.attributes, s = n.length, i = 0; i < s; i++) void 0 !== n[i] && n[i].nodeName === e && (r = n[i].nodeValue);
					return r
				}
			},
