                            ...
                            <div class="listjs-table" id="customerList">
                                <div class="table-responsive">
                                   ...
                                   <tr>
                                            ...
                                            <td>{{$value['staff']}}</td>
                                            <td>{{$value['mobile']}}</td>
                                            <td>{{ $stateCounts[$value['id']] }}</td>
                                            <td>

                                                <div class="d-flex gap-2">
                                                    <div class="view">
                                                        <a href="{{url('reassign_customer/'.$value['id'].'')}}" class="btn btn-sm btn-success view-item-btn" data-bs-toggle="tooltip" data-bs-placement="top" title="View">
