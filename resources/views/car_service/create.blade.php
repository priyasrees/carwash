                ...
                <div class="col-lg-12">
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            @endif
                            <form method="post" action="{{route('carservices.store')}}" autocomplete="off">
                                @csrf
                                <div class="row align-items-center">
                                    <div class="col-lg-6">
                                        <label for="car_service" class="form-label">Car Service<span class="text-danger">*</span></label>
                                        <input type="text" name="car_service_name" id="car_service" class="form-control {{$errors->has('car_service')?'invalid-feedback':''}}" required value="{{ old('car_service_name') ?? '' }}">
