                        ...
                        <div class="card-header">
                            <div class="row">
                                ...
                                <div class="col-2 text-end">
                                            <a class="btn btn-primary add-btn" href="{{route('carservices.create')}}"
                                           >
...
<tr>
    ...
    <td>
        ...
        <div class="d-flex gap-2">
            ...
            <div class="edit">
                <a href="{{route('carservices.edit',$value['id'])}}" class="btn btn-sm btn-success edit-item-btn" data-index="{{ $key }}" data-id="{{$value['id']}}"  title="Edit">
...
$('#delete-record').on('click', function () {
            $.ajax({
                url: "{{ url('/carservices') }}/" + recordIdToDelete,
                type: 'DELETE',
                headers: {
