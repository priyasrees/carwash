<!DOCTYPE html>
    ...
    <!-- Mirrored from themesbrand.com/velzon/html/minimal/{{url('/')}} by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 18 Dec 2023 13:42:32 GMT -->
    <head>
        ...
        <meta content="car wash" name="description" />
        ...
        <link href="{{url('/assets/css/custom.min.css')}}" rel="stylesheet" type="text/css" />
         <!-- Datatables Css-->
         <link href="{{url('/assets/css/datatables/bootstrap5.3.0.min.css')}}" rel="stylesheet" type="text/css" />
         <link href="{{url('/assets/css/datatables/bootstrap5.min.css')}}" rel="stylesheet" type="text/css" />
...
.navbar-menu,.navbar-header,.topbar-user{
    background-color: #FFDB58;

}
.nav-link,.navbar-header,#topnav-hamburger-icon,.btn-topbar,.user-name-text,.user-name-sub-text{
                    ...
                    <div class="d-flex">
                        ...
                        <div class="navbar-brand-box horizontal-logo">
                            <a href="{{url('/')}}" class="logo logo-dark">
                                <span class="logo-sm">
                                    <img src="{{url('/assets/images/carwashlogo.png')}}" alt="" height="22">
                                </span>
                                <span class="logo-lg">
                                    <img src="{{url('/assets/images/carwashlogo.png')}}" alt="" height="17">
                                </span>
                            </a>
                        ...
                        <div class="dropdown ms-sm-3 header-item topbar-user">
                            <button type="button" class="btn" id="page-header-user-dropdown" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                <span class="d-flex align-items-center">
                                    <img class="rounded-circle header-profile-user" src="{{url('assets/images/users/user-dummy-img.jpg')}}" alt="Header Avatar">
                                    <span class="text-start ms-xl-2">
                                        <span class="d-none d-xl-inline-block ms-1 fw-medium user-name-text">Car Wash</span>
        ...
        <div class="app-menu navbar-menu">
            ...
            <div class="navbar-brand-box">
                ...
                <a href="{{url('/')}}" class="logo logo-dark">
                    ...
                    <span class="logo-lg">
                        <img src="{{url('/assets/images/carwashlogo.png')}}" alt="" width="" height="68">
                    </span>
                </a>
                <!-- Light Logo-->
                <a href="{{url('/')}}" class="logo logo-light">
            ...
            <div id="scrollbar">
                <div class="container-fluid">
                    ...
                    <ul class="navbar-nav" id="navbar-nav">
                        ...
                        <!--car-->
                        <li class="nav-item">
                            <a class="nav-link menu-link" href="{{route('cardetail.index')}}" role="button" aria-expanded="false" aria-controls="">
                                <i class="mdi mdi-car"></i> <span data-key="t-package">Car Details</span>
                            </a>
                        </li>

                         {{-- <!-- car service -->
                         <li class="nav-item">
                            <a class="nav-link menu-link" href="{{url('carservices')}}" role="button" aria-expanded="false" aria-controls="">
                                <i class="mdi mdi-car-hatchback"></i> <span data-key="t-package">Car Service</span>
                            </a>
                        </li> --}}
  <!-- Package -->
  <li class="nav-item">
    <a class="nav-link menu-link" href="{{url('packages')}}" role="button" aria-expanded="false" aria-controls="">
        <i class="mdi mdi-package"></i> <span data-key="t-package">Package</span>
    </a>
</li>
                        <li class="nav-item">
                        ...
                        <li class="nav-item">
                            <a class="nav-link menu-link" href="{{url('order_details')}}" role="button" aria-expanded="false" aria-controls="">
                                <i class="mdi mdi-cart-outline"></i><span data-key="t-order_details">Order Details</span>
                            </a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link menu-link" href="{{url('payment')}}" role="button" aria-expanded="false" aria-controls="">
                                <i class="mdi mdi-credit-card"></i><span data-key="t-carservice">Payment History</span>
                            </a>
                        </li>
                        <li class="nav-item">
                        ...
                        {{-- <li class="nav-item">
                            <a class="nav-link menu-link" href="#" role="button" aria-expanded="false" aria-controls="">
                                <i class="mdi mdi-credit-card"></i><span data-key="t-carservice">Settings</span>
                            </a>
                        </li> --}}
                        <li class="nav-item">
                            <a class="nav-link menu-link" href="{{url('logout')}}" role="button" aria-expanded="false" aria-controls="">
        ...
        <footer class="footer">
            <div class="container-fluid">
                <div class="row">
                    <div class="col-sm-6">
                        <script>document.write(new Date().getFullYear())</script> © SarasWeb Solutions.
                    </div>
                    <div class="col-sm-6">
                        <div class="text-sm-end d-none d-sm-block">
                            Design & Develop by SarasWeb Solutions
                        </div>
                    </div>
                </div>
            </div>
...
<!-- DataTables -->
<script src="{{url('assets/js/jquery1.13.7.datatables.min.js')}}"></script>
<script src="{{url('assets/js/jquery-1.13.7.datatables.bootstrap5.min.js')}}"></script>
