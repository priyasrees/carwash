...
@endif --}}
                            ...
                            <form method="post" action="{{route('cardetail.store')}}" autocomplete="off">
                                ...
                                <div class="row align-items-center">
                                    <div class="col-lg-4">
                                        ...
                                        <input type="text" name="car_name" id="car_name" class="form-control" required  value="{{ old('car_name') ?? '' }}">
                            ...
                            @endif
                                    ...
                                    <div class="col-lg-4">
                                        ...
                                        <input type="text" name="car_model" id="car_model" class="form-control" required  value="{{ old('car_model') ?? '' }}">
                                    ...
                                    <div class="col-lg-4">
                                        ...
                                        <input type="text" name="car_weight" id="car_weight" class="form-control {{$errors->has('car_weight')?'invalid-feedback':''}}"  value="{{ old('car_weight') ?? '' }}">
