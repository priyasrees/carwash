                ...
                <div class="col-lg-12">
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            @endif
                            <form method="post" action="{{route('packages.update',$package->id)}}" autocomplete="off">
                                @method('put')
                                @csrf
                                <div class="row align-items-center">
                                    <div class="col-lg-4">
                                        ...
                                        <input type="text" name="package_name" id="package_name" class="form-control"
                                            required value="{{ $package->package_name }}"
                                    ...
                                    <div class="col-lg-4">
                                        ...
                                        <input type="number" min="0" name="package_amount" id="package_amount"
                                            class="form-control" required value="{{ $package->package_amount }}"
                                        ...
                                        <div class="row">
                                            <div class="col-lg-6">
                                                <select class="form-control"  name="validity" required>
                                                    ...
                                                    <option value="0" {{ $package->validity == '0' ? 'selected' : '' }}>Months</option>
                                                    <option value="1" {{ $package->validity == '1' ? 'selected' : '' }}>Year</option>
                                                                                                </select>
                                            </div>
                                            <div class="col-lg-6">
                                                <input type="number" class="form-control" value="{{$package->valid_days}}" name="valid_days"
                                ...
                                {{-- <div class="row mt-3">
                                    <div class="col-lg-4">
                                        ...
                                        <select class="form-control" required name="car_service">
                                            ...
                                            <option value="{{$value['id']}}" {{ $package->car_service == $value['id'] ? 'selected' : '' }}>
